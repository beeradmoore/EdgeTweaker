---
layout: Conceptual
title: Microsoft Edge Browser Policy Documentation LocalNetworkAllowedForUrls | Microsoft Learn
canonicalUrl: https://learn.microsoft.com/en-us/deployedge/microsoft-edge-policies/localnetworkallowedforurls
...
ms.custom: 
description: 'Windows and Mac documentation for supported Microsoft Edge Browser policy: Allow sites to make network requests to local network endpoints.'
locale: en-us
document_id: 19c87d43-08cd-05dd-8d52-e8d2892cbfb8
document_version_independent_id: 19c87d43-08cd-05dd-8d52-e8d2892cbfb8
updated_at: 2026-05-22T04:11:00.0000000Z
original_content_git_url: https://github.com/MicrosoftDocs/Edge-Enterprise-pr/blob/live/edgeenterprise/microsoft-edge-policies/LocalNetworkAllowedForUrls.md
gitcommit: https://github.com/MicrosoftDocs/Edge-Enterprise-pr/blob/7994bce7d6018fbcf8930c7152ea4c5b85aadcfd/edgeenterprise/microsoft-edge-policies/LocalNetworkAllowedForUrls.md
...
word_count: 303
asset_id: microsoft-edge-policies/localnetworkallowedforurls
moniker_range_name: 
monikers: []
item_type: Content
source_path: edgeenterprise/microsoft-edge-policies/LocalNetworkAllowedForUrls.md
cmProducts:
...
platformId: f8152878-7a9f-c1cc-da37-c448fcfa4d73
---

# Microsoft Edge Browser Policy Documentation LocalNetworkAllowedForUrls | Microsoft Learn
...
- Path (Mandatory): SOFTWARE\Policies\Microsoft\Edge\LocalNetworkAllowedForUrls
...
SOFTWARE\Policies\Microsoft\Edge\LocalNetworkAllowedForUrls\1 =

```
http://www.example.com:8080
```

SOFTWARE\Policies\Microsoft\Edge\LocalNetworkAllowedForUrls\2 =
...
- Preference Key name: LocalNetworkAllowedForUrls
- Example value:
