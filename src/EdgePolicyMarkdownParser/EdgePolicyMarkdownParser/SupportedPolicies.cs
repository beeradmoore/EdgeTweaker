...
public static class SupportedPolicies
{
	static Dictionary<string, bool> _supportedPolicies = new Dictionary<string, bool>()
	{
		...
		{ "OnBulkDataEntryEnterpriseConnector", true },
		{ "OnFileAttachedEnterpriseConnector", true },
		{ "OnPrintEnterpriseConnector", true },
		{ "OnSecurityEventEnterpriseConnector", true },
		{ "DefaultDesktopSiteSetting", true },
		{ "DefaultIdleDetectionSetting", true },
		{ "DefaultLocalFontsSetting", true },
		{ "DesktopSiteForceForUrls", true },
		{ "EdgeFileUploadAllowedForUrls", true },
		{ "EdgeFileUploadBlockedForUrls", true },
		{ "GeolocationBlockedForUrls", true },
		{ "IdleDetectionAllowedForUrls", true },
		{ "IdleDetectionBlockedForUrls", true },
		{ "LocalFontsAllowedForUrls", true },
		{ "LocalFontsBlockedForUrls", true },
		{ "MobileSiteForceForUrls", true },
		{ "PdfLocalFileAccessAllowedForDomains", true },
		{ "PreciseGeolocationAllowedForUrls", true },
		{ "EdgeCopilotEnabled", true },
		{ "Microsoft365CopilotChatIconEnabled", true },
		{ "PreferSlowCiphers", true },
		{ "PreferSlowKexAlgorithms", true },
		{ "DefaultDownloadDirectory", true },
		{ "DownloadBlockedForFileTypes", true },
		{ "EdgeSafeHostingExtensionEnabled", true },
		{ "MandatoryExtensionsForInPrivateNavigation", true },
		{ "AuthAndroidNegotiateAccountType", true },
		{ "AuthNegotiateDelegateByKdcPolicy", true },
		{ "EdgeBlockSignInEnabled", true },
		{ "EdgeOpenExternalLinksWithAppSpecifiedProfile", true },
		{ "EdgeOpenExternalLinksWithPrimaryWorkProfileEnabled", true },
		{ "EditProfileEnabled", true },
		{ "M365AuthPopupsInWorkEnabled", true },
		{ "WebSSOInIframeEnabled", true },
		{ "ImportPasswordsDisabled", true },
		{ "EdgeEnableKioskMode", true },
		{ "EdgeShowAddressBarInKioskMode", true },
		{ "EdgeShowBottomBarInKioskMode", true },
		{ "AllowEdgeDataInBackups", true },
		{ "EdgeAllowedAccountOnly", true },
		{ "EdgeAllowedAccountUPN", true },
		{ "MAMWithDeviceDLPEnabled", true },
		{ "ManagedTopSites", true },
		{ "AdditionalDnsQueryTypesEnabled", true },
		{ "EdgeNetworkStackPref", true },
		{ "HappyEyeballsV3Enabled", true },
		{ "LocalNetworkAccessAllowedForUrls", true },
		{ "LocalNetworkAccessBlockedForUrls", true },
		{ "LocalNetworkAccessIpAddressSpaceOverrides", true },
		...
		{ "LocalNetworkAllowedForUrls", true },
		{ "LocalNetworkBlockedForUrls", true },
		{ "LoopbackNetworkAllowedForUrls", true },
		{ "LoopbackNetworkBlockedForUrls", true },
		{ "BiometricAuthenticationBeforeFilling", true },
		{ "PasswordManagerPasskeysEnabled", true },
		{ "ThirdPartyPasswordManagersAllowed", true },
		{ "RAMResourceControlsEnabled", true },
		{ "ProtectedContentIdentifiersAllowed", true },
		{ "ProxyOverrideRules", true },
		{ "ScarewareBlockerAllowListDomains", true },
		{ "ScarewareBlockerBlocksDetectedSitesEnabled", true },
		{ "ScarewareBlockerSendDetectedSitesToSmartScreenEnabled", true },
		{ "ConfigureNTPFeedTabVisibility", true },
		{ "SetNTPDefaultFeedTab", true },
		{ "WebRtcPostQuantumKeyAgreement", true },
		{ "AllowBrowsingWithCopilot", true },
		{ "AntiParallelOnStartUpEnabled", true },
		{ "BackForwardCacheEnabled", true },
		{ "BrowserGuestModeEnforced", true },
		{ "BrowsingWithCopilotAllowList", true },
		{ "BrowsingWithCopilotBlockList", true },
		{ "BuiltInAIAPIsEnabled", true },
		{ "CopilotAddressBarSuggestionsEnabled", true },
		{ "CopilotNewTabPageEnabled", true },
		{ "CpuPerformanceTierOverride", true },
		{ "CredentialProviderPromoEnabled", true },
		{ "DataUrlInWebWorkerOpaqueOriginEnabled", true },
		{ "DeveloperToolsAvailabilityAllowlist", true },
		{ "DeveloperToolsAvailabilityBlocklist", true },
		{ "EdgeBrandColor", true },
		{ "EdgeBrandLogo", true },
		{ "EdgeDisableShareUsageData", true },
		{ "EdgeHistoryAISearchEnabled", true },
		{ "EdgeLockedViewModeAllowedActions", true },
		{ "EdgeLockedViewModeEnabled", true },
		{ "EdgeMyApps", true },
		{ "EdgeOneAuthProxy", true },
		{ "EdgeProxyPacFailOpenEnabled", true },
		{ "EdgeProxyPacUrl", true },
		{ "EdgeSharedDeviceSupportEnabled", true },
		{ "EnableUnsafeSwiftShader", true },
		{ "ForceForegroundPriorityForAllTabs", true },
		{ "ForceForegroundPriorityForUrls", true },
		{ "InPrivateModeUrlAllowlist", true },
		{ "InPrivateModeUrlBlocklist", true },
		{ "LaunchEdgeOnWindowsStartupEnabled", true },
		{ "LiveVideoTranslationEnabled", true },
		{ "M365LinksAutoOpenCopilotEnabled", true },
		{ "MaxConnectionsPerProxyForWebSocket", true },
		{ "NTPContentSuggestionsEnabled", true },
		{ "OriginKeyedProcessesEnabled", true },
		{ "OverlayPermissionDetectionEnabled", true },
		{ "PolicyRefreshRate", true },
		{ "PrefetchWithServiceWorkerEnabled", true },
		{ "ProvisionalNotificationsAllowed", true },
		{ "ReadExtendedCertificateLocationsEnabled", true },
		{ "ReduceIPAddressChangeNotificationEnabled", true },
		{ "RelaunchFastIfOutdated", true },
		{ "RestrictCoreSharingOnRenderer", true },
		{ "ServiceWorkerAutoPreloadEnabled", true },
		{ "ShareBrowsingHistoryWithCopilotSearchAllowed", true },
		{ "SharedWorkerExtendedLifetimeEnabled", true },
		{ "ShowTabPreviewEnabled", true },
		{ "SilentPrintingEnabled", true },
		{ "StandardizedBrowserZoomEnabled", true },
		{ "StaticStorageQuotaEnabled", true },
		{ "TLS13EarlyDataEnabled", true },
		{ "TwaDisclosureUiMode", true },
		{ "WarnBeforeQuittingEnabled", true },
		{ "WebAnnotations", true },
		{ "WebAppInstallByUserEnabled", true },
